...
class ReservationController extends Controller
{
  ...
  public function ConsulterReservation(){
    ...
    $R = Reservation::all()->Where('Client',$C->id)->first();
    $Liste = Reservation::all()->Where('Client',$C->id);
    $Note = Note::all()->Where('Client',$R->id);
  ...
  public function Terminer($Id){
    ...
    $Voiture = Voiture::all()->Where('id',$Reservation->Voitures->id)->first();
    $Reservation->Etat = 3;
    $Reservation->save();
