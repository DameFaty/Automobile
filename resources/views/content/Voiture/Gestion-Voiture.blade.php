        ...
        <table class="table table-hover">
            ...
            <tbody class="table-border-bottom-0">
                ...
                <tr>
                    ...
                    @elseif($T->Chauffeur != 0)
                    <td>
                        {{$T->Information->Prenom.' '.$T->Information->Nom}}
                    </td>
                    @endif
                    <td>
                        {{$T->Statuts->Description}}
                    </td>
                    <td>
                        <center>
                            {{$T->Kilometrage}} Km
                    ...
                    <td>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="{{url('Statut/'.$T->id.'/')}}"><i class="mdi mdi-pencil-outline me-1"></i> Change Statut</a>
                                @if($T->Chauffeur == 0)
                                <a class="dropdown-item" href="{{url('Chauffeur/'.$T->id.'/')}}"><i class="mdi mdi-pencil-outline me-1"></i> Assigner Driver</a>
                                @else
                                <a class="dropdown-item" href="{{url('Chauffeur/'.$T->id.'/')}}"><i class="mdi mdi-pencil-outline me-1"></i> Change Driver</a>
                                @endif
